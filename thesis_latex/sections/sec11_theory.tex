...
\item Expected range: $[(1-\sqrt{0.08})^2, (1+\sqrt{0.08})^2] \approx [0.51, 1.65]$
\end{itemize}
...
\midrule
0.3 & 2.14 & 0.48 & $\times$ No (near random) \\
...
\begin{itemize}
\item \textbf{Low correlation ($\rho = 0.3$)}: $\lambda_1 \approx 2.14$ slightly exceeds MP upper bound (1.65) $\rightarrow$ weakly structured
