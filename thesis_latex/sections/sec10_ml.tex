...
\begin{enumerate}
    ...
    \item \textbf{Machine learning dramatically improves $F_1$}: 0.014 $\rightarrow$ 0.578 (Random Forest, best-performing model)
        \begin{itemize}
    ...
    \item \textbf{Sharpe improvement exists but modest}: Random Forest achieves Sharpe $+0.47$ (initial estimate) vs sector-specific baseline
        \begin{itemize}
