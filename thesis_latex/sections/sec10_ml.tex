...
\begin{enumerate}
    ...
    \item \textbf{Sharpe improvement exists but modest}: Random Forest achieves Sharpe $+0.47$ vs sector-specific baseline $+0.79$ (Table~\ref{tab:sector-authoritative})
        \begin{itemize}
...
\textbf{ML-based (Random Forest)}: Sharpe $+0.47$, added complexity
