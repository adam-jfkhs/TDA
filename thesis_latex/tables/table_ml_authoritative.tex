...
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
    ...
    \item \textbf{Compare to Table~\ref{tab:sector-authoritative}}: Sector-specific (simple thresholds) initially estimated Sharpe $+0.79$; verified at $-0.77$ (Section~\ref{sec:conclusion})
