...
\begin{table}[H]
\centering
\caption{Sector-Specific vs Cross-Sector Performance (Authoritative Results)}
...
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
    ...
    \item \textbf{Verification}: Independent backtest with look-ahead-free methodology, 1-day signal lag, and test window including the 2022 bear market yields Sharpe $-0.77$ (see Section~\ref{sec:conclusion} and \texttt{risk\_report.py}). The positive Sharpe ratios above reflect initial estimates inflated by favorable test-window selection and same-day signal bias.
\end{itemize}
\end{minipage}
