...
This inequality transforms the empirical correlation-stability relationship ($\rho = -0.95$ between correlation and CV) into a \textbf{theoretically motivated pattern}, drawing on random matrix theory and spectral graph analysis.
