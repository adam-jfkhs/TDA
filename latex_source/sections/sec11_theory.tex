...
Given the strategy's trading frequency, we report Sharpe ratios under various cost assumptions:
...
\midrule
Technology & 0.56 & 0.54 & 0.50 & 0.46 \\
Energy & 0.22 & 0.20 & 0.16 & 0.12 \\
Healthcare & 1.04 & 1.01 & 0.95 & 0.89 \\
\bottomrule
\multicolumn{5}{l}{\footnotesize Cost applied per round-trip. Only active sectors shown.}
\end{tabular}
\end{table}

\textbf{Interpretation}: Strategy remains profitable under realistic cost assumptions (5--15 bps) for most sectors. Healthcare shows particular robustness with Sharpe $> 0.89$ even at 25 bps costs.
